...
flags.DEFINE_integer("output_height", 80, "The size of the output images to produce [64]")
flags.DEFINE_integer("output_width", 128,
                     "The size of the output images to produce. If None, same value as output_height [None]")
flags.DEFINE_string("dataset", "women-Sweatshirts_Hoodies", "The name of dataset [celebA, mnist, lsun]")
...
def main(_):
    ...
    with tf.Session(config=run_config) as sess:
        ...
        if FLAGS.train:
            ...
            print("------------测试开始------------")
            want_name = input("请输入衣服的类型")
            want_name_dir = "./out/{}/checkpoint".format(want_name)

            load_success, load_counter = dcgan.load(want_name_dir)
